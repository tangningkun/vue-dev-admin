    ...
    <div class="p-0">
        <PageWrapper title="devextreme-from">
            <CollapseContainer title="devextreme-from表单示例">
                <DevExtremeForm ref="dxFormRef" :schemas="schemas" :form-data="formData" />
                <!-- <DevExtremeForm @register="register" /> -->
            </CollapseContainer>

            <template #rightFooter>
                <DxButton :on-click="onClickinstance" text="onClickinstance" />

                <DxButton :on-click="onClickvalidate" text="onClickvalidate" />
            </template>
        </PageWrapper>
    </div>
</template>
...
<script lang="ts">
    ...
    import { DevExtremeForm, dxFormActionType, dxFormItemOption } from '/@/components/devextreme/devextreme-form/index';
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const formData = {
                ...
                Skype: 'John has been in the Audio/Video industry since 1990. He has led DevAV as its CEO since 2003.\r\nWhen not working hard as the CEO, John loves to golf and bowl. He once bowled a perfect game of 300.',
            };
